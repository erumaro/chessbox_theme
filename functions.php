...
function chessbox_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'chessbox_custom_background_args', array(
...
function new_excerpt_more( $more ) {
	return ' <a class="read-more" href="'. get_permalink( get_the_ID() ) . '">' . __('Läs vidare', 'your-text-domain') . '</a>';
}
